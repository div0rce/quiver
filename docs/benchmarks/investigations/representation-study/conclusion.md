...
and only one µarch (`apple-m2-mba`, NEON) is registered. Drawing a general bitmap-vs-selvec
...
## What can be stated now (one µarch only)
...
1. Registered ≥3 ISAs across ≥5 µarchs (x86 AVX2/AVX-512 + Graviton-class ARM added to
   `apple-m2-mba`).
